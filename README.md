...
| 平台 | 文件 | 说明 |
|---|---|---|
| Windows 10/11 x64 | `canify_windows-x64-setup.exe` | 安装版 |
| Windows 10/11 x64 | `canify_windows-x64-portable.zip` | 免安装绿色版 |
| Debian / Ubuntu | `canify-amd64.deb` | `sudo dpkg -i canify-amd64.deb` |
| Fedora / RHEL | `canify-x86_64.rpm` | `sudo rpm -i canify-x86_64.rpm` |
| 通用 Linux | `canify-amd64.AppImage` | 直接运行，无需 FUSE2 |
| 通用 Linux | `canify_linux-x64-portable.zip` | 解压即用（需系统已安装 WebKitGTK 运行时） |
